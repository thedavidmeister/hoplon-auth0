...
var x__9009__auto__ = (((rng == null))?null:rng);
var m__9010__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__9009__auto__)]);
if(!((m__9010__auto__ == null))){
return (m__9010__auto__.cljs$core$IFn$_invoke$arity$1 ? m__9010__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__9010__auto__.call(null,rng));
} else {
var m__9010__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__9010__auto____$1 == null))){
return (m__9010__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__9010__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__9010__auto____$1.call(null,rng));
} else {
...
var x__9009__auto__ = (((rng == null))?null:rng);
var m__9010__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__9009__auto__)]);
if(!((m__9010__auto__ == null))){
return (m__9010__auto__.cljs$core$IFn$_invoke$arity$1 ? m__9010__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__9010__auto__.call(null,rng));
} else {
var m__9010__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__9010__auto____$1 == null))){
return (m__9010__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__9010__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__9010__auto____$1.call(null,rng));
} else {
...
var x__9009__auto__ = (((rng == null))?null:rng);
var m__9010__auto__ = (clojure.test.check.random.split[goog.typeOf(x__9009__auto__)]);
if(!((m__9010__auto__ == null))){
return (m__9010__auto__.cljs$core$IFn$_invoke$arity$1 ? m__9010__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__9010__auto__.call(null,rng));
} else {
var m__9010__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__9010__auto____$1 == null))){
return (m__9010__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__9010__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__9010__auto____$1.call(null,rng));
} else {
...
var x__9009__auto__ = (((rng == null))?null:rng);
var m__9010__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__9009__auto__)]);
if(!((m__9010__auto__ == null))){
return (m__9010__auto__.cljs$core$IFn$_invoke$arity$2 ? m__9010__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__9010__auto__.call(null,rng,n));
} else {
var m__9010__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__9010__auto____$1 == null))){
return (m__9010__auto____$1.cljs$core$IFn$_invoke$arity$2 ? m__9010__auto____$1.cljs$core$IFn$_invoke$arity$2(rng,n) : m__9010__auto____$1.call(null,rng,n));
} else {
...
var G__15819 = z;
if(((24) > (function (){var G__15820 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__15820) : clojure.test.check.random.longs.bit_count.call(null,G__15820));
})())){
return clojure.test.check.random.longs.bit_xor(G__15819,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__15819;
}
});
...
var G__15823 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__15824 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__15823;
ret = G__15824;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__8947__auto__,writer__8948__auto__,opt__8949__auto__){
return cljs.core._write(writer__8948__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__8276__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15826__$1,cljs.core.cst$kw$state);
var vec__15828 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15828,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15828,(1),null);
